...
exports.Config = koishi_1.Schema.object({
    ...
    onebotapi: koishi_1.Schema.string().description('sd-webui API 服务器地址').default('http://127.0.0.1:8888'),
    ...
    ifdev: koishi_1.Schema.boolean().description('是否为开发环境').default(false),
